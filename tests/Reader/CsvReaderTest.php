...
use Camelot\ApiImporter\Reader\CsvReader;
...
final class CsvReaderTest extends TestCase
{
    public static function providerFiles(): iterable
    {
        ...
        $full = array_merge([['Integer Value', 'Float Value', 'String Value', 'Text Value']], $expected);

        yield 'No Headers' => ['two-line-no-headers.csv', null, $expected];
        yield 'Headers' => ['two-line-headers.csv', 0, $expected];
    }
    ...
    public function testSupports(): void
    {
        ...
        self::assertTrue($reader->supports('csv'));
        self::assertFalse($reader->supports('tsv'));
    }
}
